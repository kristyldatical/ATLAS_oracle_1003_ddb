...
spool '20191004192010_my_table.log'
...
SET ERRORLOGGING ON IDENTIFIER '6dfd1025-98e9-4f09-b8c9-c935e0296b5f'
set linesize 1000;
SELECT sys_context('userenv','server_host') as DATICAL_TRACEFILE_HOSTNAME from dual;
alter session set timed_statistics = true;
alter session set tracefile_identifier =  '20191004192010754';
...
create table ATLAS_SCHEMA_A.my_table_3(id int);
