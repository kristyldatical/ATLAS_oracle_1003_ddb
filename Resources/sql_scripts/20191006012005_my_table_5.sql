...
spool '20191006012005_my_table_5.log'
...
SET ERRORLOGGING ON IDENTIFIER 'a332772f-bda7-4208-917f-f710b8413667'
set linesize 1000;
SELECT sys_context('userenv','server_host') as DATICAL_TRACEFILE_HOSTNAME from dual;
alter session set timed_statistics = true;
alter session set tracefile_identifier =  '20191006012014278';
